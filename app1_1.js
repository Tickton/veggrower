// ── iOS SAFARI TAP FIX ──
// iOS Safari does not reliably fire click events on <button> elements.
// This polyfill catches touchend and manually dispatches click.
(function() {
  function iosTapFix(e) {
    var el = e.target;
    for (var i = 0; i < 6; i++) {
  ...
  document.addEventListener('touchend', iosTapFix, false);
})();
